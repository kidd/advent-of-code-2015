...
local turn_on = change(function()  return true end)
local turn_off = change(function() return false end)
local toggle = change(function(ta, x, y)  return not ta[x][y] end)
